...
public class Blackjack {
    ...
    public static ArrayList<FileInputStream> Songs = new ArrayList<>();
    ...
    public static void addSongs(){
        try {
            Songs.add(new FileInputStream("src/V/o/ABlackjack/Songs/Quincy/Quincy_Vein.mp3"));
        }catch(Exception e){
            System.out.println("Elijah doesn't know how to code, sorry.");
        }
        AudioPlayer.player.start(Songs.get(0));
